...
namespace SistemaAnubis.Models.BLL
{
    public class ClienteBLL
    {
        ...
        {
            MySqlCommand cmd = new MySqlCommand("call sp_inserirCli(@user,@senha,@lvl,@nome,@cpf,@email,@telefone,@celular,@cep,@num)", con.conectarBD());
            cmd.Parameters.Add("@user", MySqlDbType.VarChar).Value = dto.User;
            cmd.Parameters.Add("@senha", MySqlDbType.VarChar).Value = dto.Senha;
            cmd.Parameters.Add("@lvl", MySqlDbType.VarChar).Value = ClienteDTO.nivel;
